...
后续 `NAT-01b-b` 再引入主动探测：RFC 5780/双 socket filtering 检测、hairpin 测试、mapping lifetime 下界测量，以及真实 candidate pair 成功率回写。
...
- `NAT-01` 多观察点 STUN 和行为型 NAT Profile。
  ...
  - `NAT-01b-b` 主动 filtering/hairpin/lifetime 探测和真实 pair 成功率回写。
