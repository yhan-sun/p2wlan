...
use super::identity::{DplpmtudAckIngress, DplpmtudPathIdentity};
use super::sizes::{OuterIpPacketSize, OverlayPayloadBudget, UdpDatagramSize};
use super::state_machine::{
    DplpmtudBudgetRevisionState, DplpmtudEvent, DplpmtudProbeIdentity, DplpmtudProbeSendFailure,
    DplpmtudSnapshot, DplpmtudState, DplpmtudStateMachine, DplpmtudTransitionDecision,
    DPLPMTUD_PROBE_TIMEOUT,
};
use super::wire::{build_probe_inner_packet, DplpmtudWireToken};
...
impl DplpmtudRuntime {
    ...
    fn current_probe_token(
        ...
        let probe = entry.machine.outstanding_identity()?;
