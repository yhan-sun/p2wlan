use super::{
    debug, global_dataplane_profiler, info, is_overlay_payload_candidate,
    is_real_overlay_business_packet, is_rekey_confirmation_packet, is_replay_decrypt_error, mpsc,
    parse_direct_validation_token, should_request_direct_validation_after_decrypt, warn, watch,
    wire_counter, wire_fingerprint, Arc, CurrentSessionEvidenceGuardOutcome, DaemonError,
    DataplaneRxTrace, DirectValidationKind, InboundEvidenceFeed, InboundPacket,
    InboundUdpTransport, Instant, Ipv4Packet, MessageTransport, OverlayIngress,
    OverlayIngressEvent, PathCommitIngress, PeerManager, PendingProbeBindingCommitOutcome,
    ReceivedEncryptedPacket, RelayProbeIngress, RelayTransport, Result, WireGuardTransport,
    HEDGE_REPLAY_WARN_INTERVAL,
};
...
impl WireGuardTransport {
    ...
    /// error path.
    pub(super) fn note_hedge_duplicate_replay(&self, peers: &[String], counter: u64) {
    ...
    pub(super) async fn run_inbound_with_udp_source(
        &self,
