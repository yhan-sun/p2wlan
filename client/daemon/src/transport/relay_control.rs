...
impl WireGuardTransport {
    pub(in crate::transport) fn handle_relay_probe_ack(
        &self,
    ...
    pub(in crate::transport) fn handle_path_commit_ack(
        &self,
        peers: &Arc<PeerManager>,
    ...
    pub(in crate::transport) async fn handle_relay_probe_packet(
        &self,
        peers: &Arc<PeerManager>,
    ...
    pub(in crate::transport) async fn handle_path_commit_packet(
        &self,
        peers: &Arc<PeerManager>,
        relay_transport: Option<&Arc<RwLock<Option<RelayTransport>>>>,
        probe: PathCommitIngress<'_>,
